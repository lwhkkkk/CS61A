...
CREATE TABLE sentences AS
  SELECT "The two siblings, " || a.child || " plus " || b.child || " have the same size: " || d1.size
  from parents  As a ,parents As b ,size_of_dogs as d1 ,size_of_dogs as d2
  where a.parent =b.parent and a.child < b.child and a.child = d1.name and b.child = d2.name AND d1.size = d2.size;
